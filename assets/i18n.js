...
const STRINGS = {
  es: {
    ...
    library_rating_gr_hover: "Calificación en Goodreads asignada por Jorge Zuluaga",
    library_rating_drz: "Calificación Dr.Z:",
    library_rating_drz_hover: "Calificación especial de Jorge Zuluaga Dr.Z",
    library_drz_pending: "(pendiente)",
    library_likes_gr_hover: "Me gusta en Goodreads",
    library_likes_local_hover: "Aplausos recibidos en esta página",
  ...
  en: {
    ...
    library_rating_gr_hover: "Goodreads rating assigned by Jorge Zuluaga",
    library_rating_drz: "Dr.Z Rating:",
    library_rating_drz_hover: "Special rating by Jorge Zuluaga Dr.Z",
    library_drz_pending: "(pending)",
    library_likes_gr_hover: "Likes on Goodreads",
    library_likes_local_hover: "Claps received on this page",
